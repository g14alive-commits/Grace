      ...
      <style>{`
        ...
        *, *::before, *::after {
        ...
        .drawer-close {
          ...
          color: rgba(160,140,220,0.55); font-size: 20px;
        ...
        .session-headline {
          ...
          color: rgba(220,210,255,0.85); line-height: 1.3;
          margin-bottom: 4px;
        }

        .session-expand-arrow {
          font-size: 10px; color: rgba(160,140,220,0.35);
          margin-top: 2px;
        }
        ...
        .session-detail-label {
          ...
          text-transform: uppercase; color: rgba(160,140,220,0.40);
          margin-bottom: 4px;
        }
        ...
        .drawer-empty {
          ...
          color: rgba(140,130,180,0.45); font-style: italic;
          line-height: 1.6;
        }
      `}</style>
