    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page { min-height: 100vh; background: #0d0e1a; color: rgba(240,235,255,0.95); font-family: 'DM Sans', sans-serif; padding: 0; max-width: 680px; margin: 0 auto; }
        ...
        .content { padding: 28px 24px 60px; max-width: 600px; margin: 0 auto; width: 100%; }
